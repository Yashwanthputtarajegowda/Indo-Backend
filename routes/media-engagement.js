  ...
  router.post("/notifications/:notificationId/read", async (req, res) => {
    ...
    try {
      await markNotificationRead({
        db,
        uid: user.uid,
        notificationId: safeText(req.params.notificationId, 120),
      });
  ...
  router.get("/earnings/status", async (req, res) => {
    ...
    try {
      ...
      return res.json({
        ...
        rates: {
          videoPer1000Views: VIDEO_RATE_PER_1000_VIEWS,
  ...
  router.post("/earnings/toggle", async (req, res) => {
    ...
    try {
      ...
      await earningRef.update({
        ...
        videoRatePer1000Views: VIDEO_RATE_PER_1000_VIEWS,
        reelRatePer1000Views: REEL_RATE_PER_1000_VIEWS,
      });
